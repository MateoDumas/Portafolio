export const projects = [
  ...
  },
  {
    ...
    tags: ['React', 'TypeScript', 'Mediasoup', 'WebRTC', 'Socket.IO', 'Docker'],
    type: 'fullstack',
    repoUrl: 'https://github.com/MateoDumas/BoardWave',
    demoUrl: 'https://board-wave.vercel.app/',
    videoUrl: '/videos/BoardwaveVideo.mp4',
    video_url: '/videos/BoardwaveVideo.mp4',
    ...
    features: [
      ...
      'Pizarra Colaborativa en Tiempo Real (Yjs + Canvas)',
      'Chat Integrado y Transferencia de Archivos',
      'Gestión de Salas y Autenticación Segura',
      'Infraestructura Dockerizada en AWS con Caddy'
    ]
  },
  {
    id: 'billforge',
